...
approximate_age: 3, sex: "F", description: "big", adopt_status: "not",  shelter: shelter_1)
                pet_2 = Pet.create(name: "tiny", image: "/assets/images/tiger_test.jpg", \
approximate_age: 7, sex: "M", description: "small", adopt_status: "not", shelter: shelter_1)
